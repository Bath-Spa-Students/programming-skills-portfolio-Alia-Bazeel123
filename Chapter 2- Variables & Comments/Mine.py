'''1. Write a python code that uses three variables x, y, and z with respective values 10,20 and 30. 
...
'''2. Write a python program that takes courses marks as input and then calculates average of all the courses.
...
'''3. Write a python program that takes an input 5 from user and then type cast those values to string, 
...
'''4. Write a python program that stores an integer and string value to variables x and y. 
...
'''5. Write a python program that stores fruit names in a list named fruits. Unpack the list into three 
